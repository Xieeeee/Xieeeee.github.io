...
keywords: [single-cell multiome, heart failures, gene regulatory networks, chromatin organization, risk variants]
paper_url: https://www.medrxiv.org/content/10.1101/2025.05.08.25327176v1
paper_name: medRxiv. (2025)
---
...
For more details, please refer to our [manuscript](https://www.medrxiv.org/content/10.1101/2025.05.08.25327176v1).


<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/FNIH_heart_abstract.png" title="FNIH_Heart" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
